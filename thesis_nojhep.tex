...
As stated in the main text, it is necessary to calculate the amount of energy which is radiated out of the hadron as electromagnetic radiation. If the emitted energy is too large the hadron cannot be regarded as stable and our assumption of a steady state is invalid. This calculation can be made in two ways: a heuristic quantum mechanical calculation and a classical calculation.
