...
\label{eq:fields}
\begin{align}
&A^{0}\left(l_{1}\right)=\frac{q_2\omega}{\beta_{1}\beta_{2}\sin(\Delta\phi)+\Delta\phi}\\
&A^{\theta}\left(l_{1}\right)=-\frac{\beta_{2}q_2\omega\cos(\Delta\phi)}{\beta_{1}\beta_{2}\sin(\Delta\phi)+\Delta\phi}\\
...
This was obtained using mathematica and is presented in the appendix. To see that this complicated expression makes physical sense we calculate it in the nonrelativistic limit. First in the case of equal quark masses. This implies equal quark velocities, and we get:
