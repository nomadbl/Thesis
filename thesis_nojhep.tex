...
\label{eq:regge}
\begin{align}
&E=\cfrac{T}{\omega}\sin^{-1}(\beta)+\gamma m_{1}+m_{2}+\frac{q_{1}q_{2}\omega}{\beta}-\frac{\pi}{2}\frac{\tilde{a}\omega}{\beta}\\
&J=T\cfrac{-\cfrac{\beta}{\gamma}+sin^{-1}\left(\beta\right)}{2\omega^{2}}+m_{1}\cfrac{\gamma\beta^{2}}{\omega}\\
&\frac{\pi  \omega ^2 (a-S)}{2 \beta^2}-\frac{\beta m_1 \omega }{\sqrt{1-\beta^2}}+T\sqrt{1-\beta^2}-\frac{q_1 q_2 \omega ^2}{\beta^2}=0 \\
&\Delta\theta=\beta
\end{align}
\end{subequations}
