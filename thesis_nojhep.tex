...
\begin{equation}
P=\frac{\alpha^2 T^2}{m_q^2 \gamma^4\beta^2} \Pi\left(\beta\right)
\end{equation}
Dividing the radiated power by the hadronic width gives us the total energy radiated over the hadrons' lifetime
\begin{equation}
E_{radiated}=\frac{\alpha^2 T^2}{m_q^2 \gamma^4\beta^2 \Gamma_{hadron}} \Pi\left(\beta\right)
\end{equation}
...
\begin{equation}
E_{radiated}\simeq 24 MeV
\end{equation}
This figure represents $18\%$ of the Pion mass and $2.6\%$ of the proton mass! It should be noted the value $\Gamma_{hadron}=200 MeV$ represents the shortest lasting hadrons so the result for most hadrons would be an order of magnitude greater. Luckily the quantum mechanical result is much more encouraging.
